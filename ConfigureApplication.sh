...
while read line; do
  ...
  echo "$script"
  sshpass -p "$PASSWD" ssh -o StrictHostKeyChecking=no $USER@$IP "git clone https://github.com/narasingarao981/roboshop-shell.git;cd /home/ec2-user/roboshop-shell; sh $script"
